"""Makes templates for Experiment 21b (cosine annealing & weight decay)."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment21b_cosine_annealing_and_weight_decay/templates'
)
...
WEIGHT_DECAY_VALUES = numpy.array([1e-5, 3e-5, 5e-5, 7e-5, 9e-5])
...
def _run():
    ...
    for j in range(len(WEIGHT_DECAY_VALUES)):
        ...
        output_file_name = '{0:s}/weight-decay={1:.5f}/model.keras'.format(
            OUTPUT_DIR_NAME, WEIGHT_DECAY_VALUES[j]
        )
