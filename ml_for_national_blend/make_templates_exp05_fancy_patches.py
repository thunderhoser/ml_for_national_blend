"""Creates Chiu-net++ templates for Experiment 5."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment05_temperature_fancy_patches/templates'
)
...
BATCH_SIZES_AXIS1 = numpy.array([25, 50, 75, 100], dtype=int)
    ...
    for i in range(len(BATCH_SIZES_AXIS1)):
        for j in range(len(L2_WEIGHTS_AXIS2)):
            for k in range(len(LEAD_TIME_COUNTS_AXIS3)):
                ...
                output_file_name = (
                    '{0:s}/batch-size={1:03d}_l2-weight={2:.10f}_'
