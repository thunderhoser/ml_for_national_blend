...
NUM_LAG_TIMES = 4
USE_CONVNEXT_FLAGS = numpy.array([0, 1], dtype=bool)
...
def _run():
    ...
    for i in range(len(USE_CONVNEXT_FLAGS)):
        ...
        output_file_name = '{0:s}/use-convnext={1:d}/model.keras'.format(
            OUTPUT_DIR_NAME, int(USE_CONVNEXT_FLAGS[i])
        )
