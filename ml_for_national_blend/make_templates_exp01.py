"""Creates Chiu-net++ templates for Experiment 1."""
...
DEFAULT_OPTION_DICT = {
    ...
    chiu_net_pp_arch.ENCODER_DROPOUT_RATES_KEY: numpy.full(9, 0.),
    chiu_net_pp_arch.DECODER_NUM_CONV_LAYERS_KEY: numpy.full(8, NUM_CONV_LAYERS_PER_BLOCK, dtype=int),
    chiu_net_pp_arch.UPSAMPLING_DROPOUT_RATES_KEY: numpy.full(8, 0.),
    chiu_net_pp_arch.SKIP_DROPOUT_RATES_KEY: numpy.full(8, 0.),
