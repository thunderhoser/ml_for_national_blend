...
DEFAULT_OPTION_DICT = {
    chiu_next_pp_arch.INPUT_DIMENSIONS_CONST_KEY: numpy.array([432, 432, 4], dtype=int),
    # chiu_next_pp_arch.INPUT_DIMENSIONS_2PT5KM_RES_KEY: numpy.array([432, 432, 2, 22], dtype=int),
    ...
    # chiu_next_pp_arch.INPUT_DIMENSIONS_2PT5KM_RCTBIAS_KEY: numpy.array([432, 432, 2, 3], dtype=int),
    ...
    chiu_next_pp_arch.PREDN_BASELINE_DIMENSIONS_KEY: numpy.array([432, 432, 5], dtype=int),
    # chiu_next_pp_arch.INPUT_DIMENSIONS_LAGGED_TARGETS_KEY: numpy.array([432, 432, 2, 1], dtype=int),
    chiu_next_pp_arch.DO_CONVNEXT_V2_KEY: True,
    chiu_next_pp_arch.NWP_ENCODER_NUM_CHANNELS_KEY: numpy.array([32, 48, 64, 96, 128, 192, 256], dtype=int),
    chiu_next_pp_arch.NWP_POOLING_SIZE_KEY: numpy.full(6, 2, dtype=int),
    chiu_next_pp_arch.NWP_ENCODER_NUM_CONV_BLOCKS_KEY: numpy.full(7, NUM_CONV_BLOCKS_PER_LEVEL, dtype=int),
    chiu_next_pp_arch.NWP_ENCODER_DROPOUT_RATES_KEY: numpy.full(7, 0.),
    chiu_next_pp_arch.NWP_FC_MODULE_NUM_CONV_BLOCKS_KEY: numpy.array([1, 1, 1, 1, 1, 1, 3], dtype=int),
    chiu_next_pp_arch.NWP_FC_MODULE_DROPOUT_RATES_KEY: numpy.full(7, 0.1),
    ...
    chiu_next_pp_arch.LAGTGT_POOLING_SIZE_KEY: numpy.full(6, 2, dtype=int),
    chiu_next_pp_arch.LAGTGT_ENCODER_NUM_CONV_BLOCKS_KEY: numpy.full(7, NUM_CONV_BLOCKS_PER_LEVEL, dtype=int),
    chiu_next_pp_arch.LAGTGT_ENCODER_DROPOUT_RATES_KEY: numpy.full(7, 0.),
    chiu_next_pp_arch.LAGTGT_FC_MODULE_NUM_CONV_BLOCKS_KEY: numpy.array([1, 1, 1, 1, 1, 1, 3], dtype=int),
    chiu_next_pp_arch.LAGTGT_FC_MODULE_DROPOUT_RATES_KEY: numpy.full(7, 0.1),
    ...
    chiu_next_pp_arch.RCTBIAS_POOLING_SIZE_KEY: numpy.full(6, 2, dtype=int),
    chiu_next_pp_arch.RCTBIAS_ENCODER_NUM_CONV_BLOCKS_KEY: numpy.full(7, NUM_CONV_BLOCKS_PER_LEVEL, dtype=int),
    chiu_next_pp_arch.RCTBIAS_ENCODER_DROPOUT_RATES_KEY: numpy.full(7, 0.),
    chiu_next_pp_arch.RCTBIAS_FC_MODULE_NUM_CONV_BLOCKS_KEY: numpy.array([1, 1, 1, 1, 1, 1, 3], dtype=int),
    chiu_next_pp_arch.RCTBIAS_FC_MODULE_DROPOUT_RATES_KEY: numpy.full(7, 0.1),
    chiu_next_pp_arch.RCTBIAS_FC_MODULE_USE_3D_CONV: True,
    chiu_next_pp_arch.DECODER_NUM_CHANNELS_KEY: numpy.array([40, 60, 80, 120, 160, 240], dtype=int),
    chiu_next_pp_arch.DECODER_NUM_CONV_BLOCKS_KEY: numpy.full(6, NUM_CONV_BLOCKS_PER_LEVEL, dtype=int),
    chiu_next_pp_arch.UPSAMPLING_DROPOUT_RATES_KEY: numpy.full(6, 0.),
    chiu_next_pp_arch.SKIP_DROPOUT_RATES_KEY: numpy.full(6, 0.),
