...
DEFAULT_OPTION_DICT = {
    ...
    chiu_next_pp_arch.NWP_FC_MODULE_NUM_CONV_BLOCKS_KEY: 1,
    ...
    chiu_next_pp_arch.LAGTGT_FC_MODULE_NUM_CONV_BLOCKS_KEY: 1,
    ...
    chiu_next_pp_arch.RCTBIAS_FC_MODULE_NUM_CONV_BLOCKS_KEY: 1,
