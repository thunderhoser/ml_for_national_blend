...
- Full domain
- Full resolution
- Variables: all keys in list `wrf_arw_utils.ALL_FIELD_NAMES`
...
OUTPUT_DIR_HELP_STRING = (
    ...
    'zarr file per model run) by `wrf_arw_io.write_file`, to exact locations '
    'determined by `wrf_arw_io.find_file`.'
)
...
def _run(input_dir_name, first_init_time_string, last_init_time_string,
    ...
    forecast_hours = numpy.array([2, 24, 48], dtype=int)
