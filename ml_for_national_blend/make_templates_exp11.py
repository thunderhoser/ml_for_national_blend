"""Creates Chiu-net++ templates for Experiment 11.

Same as Experiment 10, but without recent biases and with all 5 target fields.
"""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment11_crps_all_targets/templates'
)
