"""Creates Chiu-net++ templates for Experiment 3."""
...
OUTPUT_DIR_NAME = (
    ...
    'experiment03_ablation_small_grid/templates'
)
...
DEFAULT_OPTION_DICT = {
    ...
    chiu_net_pp_arch.PREDN_BASELINE_DIMENSIONS_KEY: numpy.array([449, 449, 5], dtype=int),
