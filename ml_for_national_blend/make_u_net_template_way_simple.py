"""Makes way-simple U-net architecture."""
...
OUTPUT_DIR_NAME = (
    ...
    'u_net_architecture_way_simple/template'
)
...
# Predictors will include one NWP model at 2.5-km resolution:
...
INPUT_DIMS_2PT5KM = numpy.array(
    [PATCH_SIZE_ONE_DIM, PATCH_SIZE_ONE_DIM, 8], dtype=int
)
...
def _run():
    ...
    option_dict = {
        ...
        u_net_architecture.NWP_ENCODER_NUM_CHANNELS_KEY:
            numpy.array([8, 10, 12, 14, 16, 18], dtype=int),
        ...
        u_net_architecture.DECODER_NUM_CHANNELS_KEY:
            numpy.array([8, 10, 12, 14, 16], dtype=int),
